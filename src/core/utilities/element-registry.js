...
export const ELEMENT_TYPES = [
    { type: 'section', label: 'Section', icon: 'â˜', tag: 'section', container: true },
    { type: 'container', label: 'Container', icon: 'â–£', tag: 'div', container: true },
    { type: 'row', label: 'Row', icon: 'â–¤', tag: 'div', container: true },
    { type: 'column', label: 'Column', icon: 'â–¥', tag: 'div', container: true },
    { type: 'div', label: 'Div', icon: 'â–¡', tag: 'div', container: true },
    { type: 'card', label: 'Card', icon: 'â–§', tag: 'div', container: true },
    { type: 'text', label: 'Text', icon: 'T', tag: 'span', container: false },
    { type: 'heading', label: 'Heading', icon: 'H', tag: 'h2', container: false },
    { type: 'paragraph', label: 'Paragraph', icon: 'Â¶', tag: 'p', container: false },
    { type: 'button', label: 'Button', icon: 'â–¢', tag: 'button', container: false },
    { type: 'link', label: 'Link', icon: 'ðŸ”—', tag: 'a', container: false },
    { type: 'image', label: 'Image', icon: 'ðŸ–¼', tag: 'img', container: false },
    { type: 'icon', label: 'Icon', icon: 'â˜…', tag: 'i', container: false },
    { type: 'svg', label: 'SVG', icon: 'â—‡', tag: 'svg', container: false },
    { type: 'video', label: 'Video', icon: 'â–¶', tag: 'video', container: false },
    { type: 'audio', label: 'Audio', icon: 'â™«', tag: 'audio', container: false },
    { type: 'input', label: 'Input', icon: 'â–', tag: 'input', container: false },
    { type: 'textarea', label: 'Textarea', icon: 'â–‚', tag: 'textarea', container: false },
    { type: 'select', label: 'Select', icon: 'â–¾', tag: 'select', container: false },
    { type: 'checkbox', label: 'Checkbox', icon: 'â˜‘', tag: 'div', container: false },
    { type: 'radio', label: 'Radio', icon: 'â—‰', tag: 'div', container: false },
    { type: 'table', label: 'Table', icon: 'âŠž', tag: 'table', container: true },
    { type: 'list', label: 'List', icon: 'â‰¡', tag: 'ul', container: true },
    { type: 'form', label: 'Form', icon: 'ðŸ“‹', tag: 'form', container: true }
];
