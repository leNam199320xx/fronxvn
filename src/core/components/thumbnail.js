import { THUMBNAIL_WIDTH, THUMBNAIL_HEIGHT, THUMBNAIL_BG, THUMBNAIL_INNER_FILL, THUMBNAIL_STROKE, THUMBNAIL_STROKE_WIDTH, THUMBNAIL_FONT_SIZE, THUMBNAIL_TEXT_COLOR } from '../utilities/config.js';

export function generateThumbnail(elements) {
