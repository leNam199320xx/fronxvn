...
const PATHS = Object.freeze({
    reset: './src/studio/styles/base/reset.css',
    editor: './src/studio/styles/editor.css',
    'future-theme-light': './src/studio/styles/themes/light.css',
    'future-theme-dark': './src/studio/styles/themes/dark.css'
});
