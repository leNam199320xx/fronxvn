...
import { JSZIP_CDN_URL, EXPORT_INDENT, BREAKPOINTS } from './config.js';
...
export class ExportManager {
    ...
    _elementToHTML(el, indent) {
        ...
        // Không export component meta-attrs (chỉ dùng trong editor)
        // data-component-id và data-instance-id được bỏ qua
        ...
        // Không export editor-only data attrs
        // (data-editor-element, data-component-id, data-instance-id được bỏ qua hoàn toàn)
    ...
    exportCSS() {
        ...
        // Inject theme CSS variables nếu có
        if (this.editor.themeManager) {
            css += this.editor.themeManager.exportThemeCSS();
        }
